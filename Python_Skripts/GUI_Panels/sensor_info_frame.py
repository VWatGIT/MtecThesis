...
class SensorInfoFrame:
    def __init__(self, parent, root):
        ...
        self.create_sensor_readings_frame(self.frame)
        self.create_sensor_plot_frame(self.frame)

        measurment_slider = tk.Scale(self.frame, from_=1, to=100, orient="horizontal", name="measurement_slider")
        ...
        sensor_readings_frame = self.frame.nametowidget("sensor_readings_frame")
        sensor_readings_frame.grid(row=1, column=1, columnspan=1, sticky="nsew", padx=10, pady=10)

        sensor_plot_frame = self.frame.nametowidget("sensor_plot_frame")
    ...
    def create_sensor_plot_frame(self, parent):
        ...
        self.frame = tk.LabelFrame(parent, text="Detected Laser Position", name="sensor_plot_frame")
